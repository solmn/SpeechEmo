...
def split_train_test(input_path = "../../datasets/corpus/IEMOCAP_angry_sad_excited_neutral/", output_path = "../../datasets/corpus/IEMOCAP_angry_sad_excited_neutral_test_train/", train_percentage = 0.8):
